...
ViewerCanv.prototype.displayStatus=function(displText,relWidth, relHeight){
...
*/
   ...
   // divEndGame.appendChild(divLinks);
    ...
    divEndGame.style.width=relWidth+"px";
    divEndGame.style.height=relHeight+"px";
