...
function Platform(){
    ...
    this.speeCrashX=3;//скорость по X при которой платформа терпит аварию
    this.speeCrashY=4;//скорость по Y при которой платформа терпит аварию
...
Platform.prototype.startEngineMain=function(aY){
...
Platform.prototype.startEngineLeft=function(aX){
...
Platform.prototype.startEngineRight=function(aX){
...
Platform.prototype.stopEngineMain=function(aY){
    //this.accelerationY=aY;
    this.mainEngineStatus=0;

}

Platform.prototype.stopEngineLeft=function(aX){
    //this.accelerationX=aX;
    this.leftEngineStatus=0;
}

Platform.prototype.stopEngineRight=function(aX){
    //this.accelerationX=aX;
    this.rightEngineStatus=0;
...
PointObject.prototype.culcArea=function(telObj){
    ...
    this.areaY=this.y+(this.height-this.areaHeight)/2;
}
